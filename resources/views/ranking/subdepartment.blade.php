...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Best Sub Department Contribution</h2>
                    <div class="clearfix"></div>
                </div>
                <form action='/rankingsubdepartment/search' method="post" role="search">
                    {{ csrf_field() }}
                    ...
                    @if (isset($details))
                        @foreach ($details as $transaction)
                            <tr>
                                ...
                                <td>{{ $transaction->subdepartment_id }}</td>
                                @foreach ($subdepartments as $subdepartment)
                                    @if ($transaction->subdepartment_id == $subdepartment->id)
